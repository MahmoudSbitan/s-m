        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                <div class="ml-3 relative">
                    <x-jet-nav-link align="right" width="48"  href="{{ route('login') }}" :active="request()->is('login')">
                            {{ __('Login') }}
                    </x-jet-nav-link>

                    <x-jet-nav-link align="right" width="48"  href="{{ route('register') }}" :active="request()->is('register')">
                        {{ __('Register') }}
                </x-jet-nav-link>
                </div>
            </div>
