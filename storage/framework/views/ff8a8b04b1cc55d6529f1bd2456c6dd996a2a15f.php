    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 grid grid-cols-4 gap-4 xs-grid-col-2">
          ...
          <div class="bg-white max-h-1/2 w-full rounded-2xl hover:shadow dark:bg-gray-900">
            <a href="<?php echo e(url("/home/$item->id")); ?>">
              <img class="mx-auto w-30 max-h-80" src="<?php echo e(asset("/storage/photos/$item->img")); ?>" alt="">
              <div class="mt-2 text-gray-900 p-2 dark:text-white">
                <h2 class="text-xl font-semibold tracking-tight"><?php echo e($item->title); ?></h2>
                <h4 class="mt-1 flex justify-between items-center">
                  <?php if($item->discount > 0): ?>
                  <span class="text-gray-700">
                    <span class="font-bold text-base">$</span>
                    <span class="font-semibold text-xl tracking-tight dark:text-gray-200"><?php echo e($item->price - $item->price * ($item->discount / 100)); ?></span>
                    <small></small>
                    <p class="line-through dark:text-gray-200"><?php echo e($item->price); ?> $</p>
                  </span>
                  <span class="flex items-center mr-1">
                    <div class="bg-red-700 rounded-lg p-2 mr-1 text-white"><?php echo e($item->discount); ?>%</div>
                  </span>
                  <?php else: ?>
                  <span class="text-gray-700">
                    <span class="font-bold text-base">$</span>
                    <span class="font-semibold text-xl tracking-tight dark:text-gray-200"><?php echo e($item->price); ?></span>
                    <p></p>
                  </span>
                  <?php endif; ?>
                ...
                <div class="text-center mt-7">
                  <a class="bg-black text-gray-50 px-3 py-2 rounded-2xl hover:bg-gray-400" href="<?php echo e(url('add-to-cart/'.$item->id)); ?>">
                    Add To Cart
                  </a>
                </div>
              </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\graduation\resources\views/home/index.blade.php ENDPATH**/ ?>