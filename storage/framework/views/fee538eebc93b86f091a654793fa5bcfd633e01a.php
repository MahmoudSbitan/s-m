                          ...
                          <tr>
                            <td class="hidden pb-4 md:table-cell">
                              <a href="<?php echo e(url("/home")); ?>">
                                <img src="<?php echo e(asset("/storage/photos")); ?>/<?php echo e($details['img']); ?>" class="w-20 rounded" alt="">
                              </a>
                            </td>
                            <td data-th="">
                              <p class="mb-2 md:ml-4"><?php echo e($details['title']); ?></p>
                              <button class="text-gray-700 md:ml-4 remove-from-cart" data-id="<?php echo e($id); ?>">
                            ...
                            <td class="justify-center md:justify-end md:flex mt-6" data-th="Quantity">
                              <div class="w-20 h-10">
                                ...
                                <input type="number" min="1" value="<?php echo e($details['quantity']); ?>" 
...
<?php endif; ?>
    <?php /**PATH C:\xampp\htdocs\graduation\resources\views/cart/cart.blade.php ENDPATH**/ ?>