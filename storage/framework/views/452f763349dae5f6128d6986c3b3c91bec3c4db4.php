        ...
        <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col ">
                <div class="bg-white shadow-md rounded-3xl p-5 dark:bg-gray-900">
                    ...
                    <div class="mt-5">
                        <?php echo Form::open(['action' => 'App\Http\Controllers\CategoryController@store', 'method' => 'POST', 'enctype' => 'multipart/form-data']); ?>
                            ...
                            <div class="md:flex flex-row md:space-x-4 w-full text-xs">
                                <div class="mb-3 space-y-2 w-full text-xs">
                                    ...
                                    <input placeholder="Category Name" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4 dark:bg-gray-400" required="required" type="text" name="title" id="integration_shop_name">
                                </div>
                                <div class="mb-3 space-y-2 w-full text-xs">
                            ...
                            <div class="mt-5 text-right md:space-x-3 md:block flex flex-col-reverse">
                                ...
                                <button class="mb-2 md:mb-0 bg-green-400 px-5 py-2 text-sm shadow-sm font-medium tracking-wider text-white rounded-full hover:shadow-lg hover:bg-green-500" type="submit"><?php echo e(__('Save')); ?></button>
                            </div>
                        <?php echo Form::close(); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\graduation\resources\views/admin/categories/create.blade.php ENDPATH**/ ?>