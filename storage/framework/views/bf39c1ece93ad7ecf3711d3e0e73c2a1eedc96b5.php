        ...
        <div class="min-w-screen min-h-screen flex items-center justify-center px-5 pb-10 pt-16">
            <div class="w-full mx-auto rounded-lg bg-white shadow-lg p-5 text-gray-700" style="max-width: 600px">
                ...
                <div class="mb-3">
                    ...
                    <div>
                        <input class="w-full px-3 py-2 mb-1 border-2 border-gray-200 rounded-md focus:outline-none focus:border-indigo-500 transition-colors" placeholder="Mohammad Ahmed" type="text"/>
                    </div>
                </div>
                <div class="mb-3">
...
<?php endif; ?>
    <?php /**PATH C:\xampp\htdocs\graduation\resources\views/cart/payment.blade.php ENDPATH**/ ?>